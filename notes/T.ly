...
AgnusTenore = {
  \relative c' {
    ...
    d r h a
    h8([ a)] h4 c8 g c([ d)]
    d4^\critnote r c8\p g c([ d)]
    d4^\critnote r d\f d %40
    d c d\p d
    d c a8\f a h c
    gis a a([ gis)] a4 r
    r2 d8 c h g
    ...
    c8 c d4 d r
    e d c8([ h)] c4
    a8^\critnote c d([ g,)] g4 r %55
    \mvTr a8\p^\critnote c d([ g,)] g4 r
    r es'8\f es d4 d
    r es8\p es d4 d
    c8\f c d c h c c([ h)]
    c4 r c h %60
    c8 c c([ h)] c4 r\fermata \bar "|." %61 finis
  }
}
