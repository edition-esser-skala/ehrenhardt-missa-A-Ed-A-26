...
AgnusOrgano = {
  \relative c {
    ...
    gis e a4 dis,\f d8 c
    h a e' e, a4 r
    \clef treble << { e'''8 d c h } \\ { r4 a8 g! } >> \clef "treble_8" d c \clef bass g[ f]
    e c d e f4 c %45
    a f b8 a g c
    f,4 r b8\p a g c
    f,4 r r g'8\f f
    ...
    e c f4 h,!\f b8 a! %50
    g f c' c, f4 r
    \clef "treble_8" d''8 c h! c \clef bass g f e c
    a' g fis d g4 r
    c g e c
    f8 e d g c,4 r %55
    f8\p e d g c,4 r
...
AgnusBassFigures = \figuremode {
  ...
  r2 <6 5>
  r q %35
  <7->4 <4\+ 2>8 \bo <[6]> <6\\>4 \bc <[4]>8 <_+>
  r2. <_+>4
  \bo <[6]>2 r8 \bc q <7> <[7] _+>
  r2 r8 <[6]> <7> <7 _+>
  r2. <[5!]>4 %40
  <6 5>1
  q2 <7 [_+]>4 <4\+ 2>8 <6>
  ...
  r4 <[5-]> <6 5 [_!]>2
  r4 <[5-]> <6 5 [_!]>2
  <7->4 <4 2>8 <6> q4 <4>8 <3>
  r1 %60
  <6>4 <5 4>8 <\t 3> r2 %61 finis
}
